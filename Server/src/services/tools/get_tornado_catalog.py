"""Versioned semantic tornado inspection; paired Unity Editor bridge."""
...
@mcp_for_unity_tool(
    ...
    annotations=ToolAnnotations(title="Get Tornado Catalog", readOnlyHint=True, destructiveHint=False),
)
async def get_tornado_catalog(
    ctx: Context,
    ...
    result = await send_with_unity_instance(async_send_command_with_retry, instance, "get_tornado_catalog", params)
