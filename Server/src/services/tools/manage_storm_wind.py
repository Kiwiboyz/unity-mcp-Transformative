"""Versioned semantic storm_wind authoring; paired Unity Editor bridge."""
...
@mcp_for_unity_tool(
    ...
    annotations=ToolAnnotations(title="Manage Storm Wind", readOnlyHint=False, destructiveHint=True),
)
async def manage_storm_wind(
    ctx: Context,
    ...
    result = await send_mutation(ctx, instance, "manage_storm_wind", params)
